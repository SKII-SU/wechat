...
request域名：小程序只支持 https 协议，并且要求是已备案的域名，还需配置域名证书。
...
##### 获取首页轮播图数据
- 请求路径：https://ip域名/api/public/v1/home/swiperdata
- 请求方法：GET
- 请求参数
...
- 请求路径：https://ip域名/api/public/v1/home/catitems
- 请求方法：GET
- 请求参数
...
- 请求路径：https://ip域名/api/public/v1/home/floordata
- 请求方法：GET
- 请求参数
...
##### 搜索建议查询
- 请求路径：https://ip域名/api/public/v1/goods/qsearch
- 请求方法：GET
...
##### 商品列表搜索
- 请求路径：https://ip域名/api/public/v1/goods/search
- 请求方法：GET
...
- 请求路径：https://ip域名/api/public/v1/goods/detail
- 请求方法：GET
...
##### 获取分类数据
- 请求路径：https://ip域名/api/public/v1/categories
- 请求方法：GET
...
- 请求路径：https://ip域名/api/public/v1/users/wxlogin
- 请求方法：POST
...
- 请求路径：https://ip域名/api/public/v1/my/orders/create
- 请求方法：POST
...
- 请求路径：https://ip域名/api/public/v1/my/orders/req_unifiedorder
- 请求方法：POST
- 请求参数
...
- 请求路径：https://ip域名/api/public/v1/my/orders/chkOrder
- 请求方法：POST
- 请求参数
...
- 请求路径：https://ip域名/api/public/v1/my/orders/all
- 请求方法：GET
- 请求参数
